...
class INSTRUCCIONES:
    def __init__(self):
        ...
        self.MC=pygame.image.load('pantallas\\MenuCargas.png')
        self.PC=pygame.image.load('pantallas\\MenuCP.png')
        self.FIELD=pygame.image.load('pantallas\\MenuCampo.png')
        self.ROJO=pygame.image.load('pantallas\\MenuRojo.png')
        self.FINAL=pygame.image.load('pantallas\\Menultimo.png')
