...
class PANTALLAS:
    def __init__(self):
        ...
        self.imagen_boton = pygame.image.load("sprites\\flecha.png")
        self.imagen_boton_pressed = pygame.image.load("sprites\\flecha2.png")
        ...
        self.imagen_panel = pygame.image.load('pantallas\\pantallass.jpg')
        self.clock=pygame.time.Clock()
        self.screen = pygame.display.set_mode((800, 600))
        self.fuente = pygame.font.SysFont('Courier', 20)
        self.anillo = pygame.image.load("sprites\\carga_en_anillo.png")
        self.constante=pygame.image.load("sprites\\constante.png")
        self.dipolo=pygame.image.load('sprites\\dipolo.png')
        self.text_anillo=pygame.image.load('sprites\\ANILLO.png')
        self.text_constante=pygame.image.load('sprites\\CONS.png')
        self.text_dipolo=pygame.image.load('sprites\\DIPOL.png')
        self.selector=pygame.image.load('sprites\\selector.png')
        self.start=pygame.image.load('sprites\\INICIARP.png')
